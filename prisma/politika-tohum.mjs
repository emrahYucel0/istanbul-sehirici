...
const GIZLILIK = `
<p>istanbulsehirici.com olarak kişisel verilerinizin güvenliği hususuna azami hassasiyet göstermekteyiz. Kişisel verileriniz, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK)'na uygun olarak işlenmekte ve saklanmaktadır.</p>

<h2>1. Kişisel Verilerin İşlenmesi</h2>
<p>KVKK uyarınca, istanbulsehirici.com ile paylaştığınız kişisel veriler, tamamen veya kısmen, otomatik olarak veya herhangi bir veri kayıt sisteminin parçası olmak kaydıyla otomatik olmayan yollarla elde edilerek, kaydedilerek, depolanarak, değiştirilerek, yeniden düzenlenerek; yani veriler üzerinde gerçekleştirilen her türlü işlem "kişisel verilerin işlenmesi" olarak kabul edilmektedir.</p>
...
<p>KVKK kapsamındaki amaçlarla, istanbulsehirici.com ile paylaştığınız kişisel verileriniz, ana hissedarlarımız, hissedarlarımız, reklam verenler, yurt içi/yurt dışı iştiraklerimiz; altyapımızı kullanan üye firmalar ve hizmetimizle ilişkili diğer kişi ve kuruluşlarla paylaşılabilir.</p>
...
<ul>
<li>istanbulsehirici.com internet sitesi ve mobil uygulamalarındaki formlar aracılığıyla (ad, soyad, adres, telefon, iş veya özel e-posta gibi);</li>
...
<p>istanbulsehirici.com, KVKK'nın yürürlük tarihi olan 7 Nisan 2016'dan önce yayım hayatına başlamadığı için bu tarihten önce depolanan herhangi bir kişisel veri bulunmamaktadır.</p>
...
<p>KVKK'nın 4. maddesi uyarınca, istanbulsehirici.com'un kişisel verilerinizi doğru ve güncel tutma yükümlülüğü bulunmaktadır. Bu kapsamda, üyelerimizin doğru ve güncel verilerini paylaşması veya web sitesi/mobil uygulama üzerinden güncellemesi gerekmektedir.</p>
...
<p>istanbulsehirici.com tarafından atanacak Veri Sorumlusu Temsilcisi, yasal altyapı sağlandığında Veri Sorumluları Sicilinde ve bu belgenin bulunduğu internet adresinde ilan edilecektir.</p>
<p>Kişisel veri sahipleri, sorularını, görüşlerini veya taleplerini <a href="mailto:info@istanbulsehirici.com">info@istanbulsehirici.com</a> adresine yöneltebilirler.</p>
...
const SARTLAR = `
<p>Bu Kullanım Şartları, istanbulsehirici.com tarafından sunulan web sitesi, mobil uygulama ve ilgili hizmetlerin ("Hizmet") kullanımını düzenler. Hizmeti kullanarak, bu Şartları ve ek politikalarımızı (<a href="/gizlilik-politikasi">Gizlilik Politikası</a>, <a href="/cerez-politikasi">Çerez Politikası</a> vb.) kabul etmiş sayılırsınız.</p>
...
<li>Hesabınızın yetkisiz kullanımı durumunda derhal <a href="mailto:info@istanbulsehirici.com">destek ekibimize</a> bildirimde bulunmalısınız.</li>
...
<li>Fikri mülkiyet ihlali iddiaları için <a href="mailto:info@istanbulsehirici.com">info@istanbulsehirici.com</a> adresine bildirimde bulunabilirsiniz.</li>
</ul>
